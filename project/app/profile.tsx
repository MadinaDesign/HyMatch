          ...
          <View style={[styles.profileCard, theme === 'dark' && { backgroundColor: '#27272a' }]}>
            ...
            <View style={styles.statsRow}>
              <View style={styles.statsItem}>
                <Eye size={18} color="#C19A6B" style={{ marginRight: 4 }} />
                <Text style={styles.statsText}>Views: 7</Text>
              </View>
              <View style={styles.statsItem}>
                <Clock size={18} color="#C19A6B" style={{ marginRight: 4, marginLeft: 16 }} />
