  ...
  return (
    <SafeAreaView style={[styles.container, theme === 'dark' && { backgroundColor: '#18181b' }]}>
        ...
        <View style={[styles.section, theme === 'dark' && { backgroundColor: '#27272a' }]}>
          ...
          <View style={styles.photoSection}>
            <TouchableOpacity style={styles.photoContainer} onPress={pickImage}>
              {formData.profilePicture ? (
                ...
                <View style={[styles.photoPlaceholder, theme === 'dark' && { backgroundColor: '#27272a', borderColor: '#C19A6B' }]}>
                  <Camera size={32} color="#C19A6B" />
                </View>
              )}
          ...
          <View style={styles.row}>
            <View style={styles.halfInput}>
              ...
              <TextInput
                style={[styles.input, theme === 'dark' && { backgroundColor: '#27272a', color: '#fff', borderColor: '#C19A6B' }]}
            ...
            {cvFile ? (
              <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 8 }}>
                ...
                <TouchableOpacity onPress={pickCV} style={{ marginRight: 12 }}>
                  <Text style={{ color: '#C19A6B', fontWeight: 'bold' }}>Replace</Text>
                </TouchableOpacity>
              ...
              >
                <Text style={{ color: '#C19A6B', fontWeight: 'bold' }}>Upload CV (PDF)</Text>
              </TouchableOpacity>
            )}
          </View>
        </View>
      ...
      <View style={[styles.footer, theme === 'dark' && { backgroundColor: '#27272a' }]}>
        <TouchableOpacity style={[styles.saveButton, theme === 'dark' && { backgroundColor: '#C19A6B' }]} onPress={handleSave}>
